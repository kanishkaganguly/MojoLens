...
/*
  ...
  Compute total power among Ray path with a maxium of nr = 3 reflexions
  ...
  TXpoint                               Transmitter point (3 x Nt) where Nt is the number of transmetters/beacons
  RXpoint                               Receiver point (3 x Nr) where Nr is the number of receivers.
  ...
  mex -v -f mexopts_intel10.bat -output total_power3.dll total_power3.c
            ...
            if(nr > 0)
            {
                for (i = 0 ; i < nplanes ; i++)       
                {
                    ...
                    if (rflagi == true)
                    {
                        id             = npath1*5;
                        npath1++;
                        rpath1         = (double *)realloc((double *)rpath1 , (npath1)*5*sizeof(double));
                        rpath1[0 + id] = Phiti[0];
                        rpath1[1 + id] = Phiti[1];
                        rpath1[2 + id] = Phiti[2];
                        rpath1[3 + id] = i;
                            ...
                            if (j != i)
                            {
                                ...
                                if (rflagj == true)
                                {
                                    ...
                                    if(rflagij == true)
                                    {
                                        jd             = npath2*10;
                                        npath2++;
                                        rpath2         = (double *)realloc((double *)rpath2 , (npath2)*10*sizeof(double));
                                            ...
                                            if(rflagk == true)
                                            {
                                                ...
                                                if(rflagjk == true)
                                                {
                                                    ...
                                                    if(rflagijk == true)
                                                    {
                                                        kd              = npath3*15;
                                                        npath3++;
                                                        rpath3          = (double *)realloc((double *)rpath3 , (npath3)*15*sizeof(double));
